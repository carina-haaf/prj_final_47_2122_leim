...
(Em termos de trabalho futuro, poderia abordar a otimização do sistema desenvolvido para se poder adaptar ao tipo de ambiente em que o vídeo é gravado.

O até otimizar o sistema para conseguir através da duração do evento, detetar de que lado do campo ocorrem os eventos)
