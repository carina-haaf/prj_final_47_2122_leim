...
\caption{Descrição pormenorizada do campo de padel. \cite{tennisnerd_padel_2019}}
...
\caption{Resultados da aplicação de vários algoritmos aos dados para a classe dos positivos.}
...
\caption{Resultados da aplicação de vários algoritmos aos dados para a classe dos negativos.}
