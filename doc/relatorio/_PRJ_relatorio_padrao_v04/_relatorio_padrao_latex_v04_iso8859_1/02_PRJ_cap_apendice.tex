...
\begin{figure}[h]
   \centering
   \includegraphics[width=7cm]{./NN_neuron_v2}
\caption{Representação de um neurónio de uma rede neuronal.}
\label{fig:neuroniodeumarn}
\end{figure}

Escrever aqui o detalhe adicional que melhor explique outro aspecto (diferente do que está no apêndice \ref{ch:umDetalheAdicional}) descrito no corpo principal do documento \ldots
