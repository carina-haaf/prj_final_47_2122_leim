...
A anotação de eventos sonoros em vídeo consiste no processo de análise do áudio obtido através de um vídeo, no setido de recolher informações relativas a possíveis eventos relevantes. 

Falar sobre o auxílio das novas tecnologias no desporto
Falar sobre o que é o padel
