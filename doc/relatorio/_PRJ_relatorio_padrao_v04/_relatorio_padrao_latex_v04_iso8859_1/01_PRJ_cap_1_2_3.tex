...
Os requisitos do sistema podem ser funcionais e não funcionais. Os primeiros, que também podemos ser designados por funções de sistema, referem-se funcionalidades desempenhadas pelo sistema. Neste caso, os requisitos funcionais podem ainda ser divididos em dois grupos:
...
Neste secção será feita uma descrição detalhada da abordagem utilizada para realizar cada uma das etapas inerentes ao sistema em desenvolvimento. As etapas são as seguintes:
...
(colocar aqui um esquema dos passos do processo de criação do dataset - ver os esquemas feitos pela Soraia)
